/**********************************************************************
 * based on MT940UmsatzExporter.java
 * commit 7a24e9ef63819bba0267665a9567fd6ab2878429
 * Author:     Olaf Willuhn <github@willuhn.de>
 * CommitDate: Mon Jan 5 17:13:08 2015 +0100
 * 
...
/**
 * Exportiert Umsaetze im MT940-Format. XX pretty
 */
public class MT940prettyUmsatzExporter extends AbstractPlugin implements Exporter
{
  /**
   * MT940-Zeichensatz.
      ...
      for (int i=0;i<objects.length;++i)
      {
        ...
        String ref = StringUtils.trimToNull(u.getCustomerRef());
      	...
      	// Fallback, wenn wir keinen GV-Code haben. Das trifft u.a. bei Alt-Umsaetzen
    		...
    		{
          // maschinenlesbare SEPA-Elemente sollen fuer den Export ignoriert werden
          if (lines[m].startsWith("EREF+") || lines[m].startsWith("MREF+") || lines[m].startsWith("KREF+") || lines[m].startsWith("CRED+") || lines[m].startsWith("DEBT+")) 
            continue;
          
          if (lines[m].startsWith("SVWZ+"))
              lines[m] = lines[m].substring(5);
  ...
  public IOFormat[] getIOFormats(Class objectType)
  {
    ...
    return new IOFormat[]{new IOFormat() {
      ...
      {
        return i18n.tr("Swift MT940-Format pretty");
      }
  ...
  public String getName()
  {
    return i18n.tr("MT940-Format pretty");
  }
